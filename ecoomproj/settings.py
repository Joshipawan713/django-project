"""
Django settings for ecoomproj project.
...
SECRET_KEY = 'django-insecure-la8gs^riqatp99-ml+c)f(z*b6ck3@&6a7+ddjmant-kf933bc'
...
WSGI_APPLICATION = 'ecoomproj.wsgi.application'
